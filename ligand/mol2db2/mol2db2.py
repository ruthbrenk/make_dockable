...
def parserDefaults():
  ...
  parser.add_option(
      ...
      default=500, help="limit on the number of sets, (default: %default)")
  parser.add_option(
      "--limitconf", type="long", action="store", dest="limitconf",
      default=2000, help="limit on the number of confs, (default: %default)")
  parser.add_option(
      "--limitcoord", type="long", action="store", dest="limitcoord",
      default=40000, help="limit on the number of coords, (default: %default)")
  parser.add_option(
      "--maxrecursiondepth", type=int, action="store", dest="maxrecursiondepth",
      default=2, help="Max recursive subdivision steps to take (default: %default)")
  return parser
