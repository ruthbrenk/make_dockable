...
cd $number
    ...
    $CONF_EXE -i $number.smi -o conformer.TMP.mol2 -q 2 -n 1 --hydrogens
    $PYTHON3 $DOCKBASE/ligand/rdkit/generate_conformers.py -m conformer.TMP.mol2 -N $zinc -r 1.0 -n $max_conf -o conformer.$number.mol2 -t conformer.TMP.mol2
    # rm conformer.TMP.mol2
